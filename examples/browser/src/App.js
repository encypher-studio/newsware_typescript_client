...
import "./App.css";
import { WsApi, WebsocketResponseType, WebsocketMethod, Field } from "newsware";
...
function App() {
    ...
    return (<div className="App">
            <header className="App-header">
                ...
                <input id="apikey" placeholder="Api key" value={inputApikey} onChange={e => setInputApikey(e.target.value)}/>
